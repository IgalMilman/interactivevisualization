...
//parameters=[['KMeans', 'K means', {'name':'numberofcl', 'label':'Number of clusters', 'type':'number', 'attributes':[['placeholder', '5']]}],['DBScan', 'DB scan']]
// {'parameter1': self.parameter1, 'parameter2': self.parameter2, 'parameter3': self.parameter3}
//("00000" + Math.random()*100000).slice(-5)
